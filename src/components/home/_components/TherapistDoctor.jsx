...
export const TherapistDoctor = () => {
  return (
    <>
      <div className="w-[93%] 2xl:w-[63%] mx-auto flex justify-between py-[2rem]">
        {/* {First section} */}
        <div className="flex-1">
          <div>
            <div className="flex items-center gap-2">
              <div className="w-[3%] h-[0.1rem] bg-[#000]"></div>
              <span className="text-[#e9ae0b] text-[1.2rem]">
                Therapist and Doctors
              </span>
            </div>
            <h2 className="text-[#000] text-[1.6rem] font-lato-bold w-[60%]">
              Meet Trusted Professionals, Ready to Help
            </h2>
            <div className="flex items-center gap-[0.5rem] text-[1.2rem] font-lato-bold">
          ...
          <div className="flex items-center my-[2rem]">
            <div className="flex flex-col items-center justify-center gap-[0.9rem] size-[14rem] rounded-full bg-[#fff] p-[2rem] shadow shadow-gray-600">
              <h3 className="text-[#000] text-[1.3rem] font-lato-bold">24/7</h3>
              <p className="text-center text-[0.9rem] text-[#000] font-montserrat">
                Flexible Scheduling Book sessions at your convenience.
              </p>
            </div>
            <div className="flex flex-col items-center justify-center gap-[0.9rem] size-[14rem] rounded-full bg-[#f4c851] p-[1rem] shadow shadow-gray-600 -ml-[1rem]">
        ...
        <div className="flex-1">
          ...
          <h3 className="text-[#000] text-[1.6rem] font-lato-bold">
