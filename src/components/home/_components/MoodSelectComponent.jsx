...
export const MoodSelectComponent = () => {
  return (
    <>
      <section>
        <div className="w-[90%] md:w-[51%] mx-auto text-center py-[1.7rem]">
          <h2 className="text-[1.5rem] md:text-[1.8rem] font-lato-bold text-[#000]">
            Feel Seen, Heard, and Understood
          </h2>
          <p className="font-montserrat text-[0.8rem] md:text-[0.9rem]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[2.5rem] 2xl:gap-[7rem] w-[67%] 2xl:w-[80%] mx-auto pb-[5rem]">
